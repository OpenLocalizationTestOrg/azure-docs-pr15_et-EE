<properties
pageTitle="Lisage Exceli konnektor | Microsoft Azure'i"
description="Ülevaade Exceli konnektor REST API parameetrid"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>Konnektor Exceli kasutamise alustamine

Praegu pole Exceli konnektor loogika rakendustes. 

## <a name="to-use-excel-data"></a>Exceli andmete kasutamine
Saate salvestada Exceli andmete talletamiseks kaust, nagu [OneDrive'i](connectors-create-api-onedrive.md)komaeraldusega (CSV) faili. Saate ka CSV-faili [kindla-faili konnektor](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md).
