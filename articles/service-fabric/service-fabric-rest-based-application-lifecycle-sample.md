<properties
   pageTitle="ÜLEJÄÄNUD põhisest rakendusest elutsükli valimi | Microsoft Azure'i"
   description="Microsoft Azure'i teenuse struktuuri näide, mis näitab rakenduse elutsükli teenuse struktuuri ülejäänud kasutajaliidese abil."
...
# <a name="rest-based-application-lifecycle-sample"></a>ÜLEJÄÄNUD põhisest rakendusest elutsükli näidis

See näide näitab teenuse struktuuri rakenduse elutsükli REST API vahendusel. Teenuse struktuuri rakenduse elutsükli kohta leiate lisateavet teemast [teenuse struktuuri rakenduse elutsükli](service-fabric-application-lifecycle.md).

See näide teeb järgmist:

* Sätete **WordCount 1.0.0** proovi WordCount rakendusepaketi pildil talletada.
* Kuvab loendi taotluse tüübid, mis sisaldab WordCount 1.0.0.
* Loob WordCount rakenduse **struktuuri: / WordCount**.
* Kuvatakse loend rakendustest, mis sisaldab struktuuri: / WordCount versioon 1.0.0.
* Sätted soovitud 1.1.0 versiooni WordCount valimi **WordCountUpgrade** rakendusepaketi pilt poe kaudu.
* Kuvab loendi taotluse tüübid, mis sisaldab nii WordCount 1.0.0 ja **WordCount 1.1.0**.
* Uuendab WordCount rakenduse versiooni 1.1.0.
* Kuvatakse loend rakendustest, mis sisaldab WordCount versioon 1.1.0, kuid sisaldab enam WordCount versioon 1.0.0.
* Kustutab WordCount rakendus.
* Kuvatakse loend rakendustest, mis sisaldab enam struktuuri: / WordCount.
* Unprovisions soovitud 1.1.0 versiooni WordCount proovi.
* Kuvab loendi taotluse tüübid, mis sisaldab WordCount 1.0.0, kuid sisaldab enam WordCount 1.1.0.
* Unprovisions soovitud 1.0.0 versioon WordCount proovi.
* Kuvab loendi taotluse tüübid, mis sisaldab enam WordCount.


## <a name="prerequisites"></a>Eeltingimused

See näide kasutab [WordCount näidis](http://aka.ms/servicefabricsamples) (leitud **Alustamine** näidised). Valimi WordCount ehitatakse esmalt ja seejärel kaks rakenduse paketid tuleb kopeerida pildi pood.

|Kausta|Kirjeldus|
|------|-----------|
|WordCount|WordCount valimi rakendus. **ApplicationManifest.xml** fail sisaldab **ApplicationTypeVersion = "1.0.0"**.|
|WordCountUpgrade|WordCount valimi rakendus. Faili ApplicationManifest.xml tuleb muuta **ApplicationTypeVersion = "1.1.0"** rakenduse täiendamine ilmneda juhul, kui soovite lubada.|

Luua rakenduse paketid ja kopeerige need pildi pood, toimige järgmiselt:

1. Kopeerige **C:\ServiceFabricSamples\Services\WordCount\WordCount\pkg\Debug** **C:\Temp\WordCount**. See loob WordCount rakendusepaketi.
2. Kopeerige C:\Temp\WordCount **C:\Temp\WordCountUpgrade**. See loob **WordCountUpgrade** rakendusepaketi.
3. Avage tekstiredaktoris **C:\Temp\WordCountUpgrade\ApplicationManifest.xml** .
4. **ApplicationManifest** elementi, muuta **ApplicationTypeVersion** atribuut **"**1.1.0".  See värskendab rakenduse versiooninumbri.
5. Muudetud ApplicationManifest.xml faili salvestada.
6. Käivitage rakenduste pood pildi kopeerimiseks administraatorina järgmist PowerShelli skripti:
...
PowerShelli skripti lõpulejõudmisel see rakendus on käivitamiseks valmis.

## <a name="example"></a>Näide

Järgmises näites näitab teenuse struktuuri rakenduse elutsükli.
