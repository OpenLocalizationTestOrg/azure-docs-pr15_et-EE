<properties
   pageTitle="Kasutades .NET SDK Hdinsightiga Windowsi-põhiste Hadoopi kogumite loomine | Microsoft Azure'i"
    description="Saate teada, kuidas luua Hdinsightiga kogumite Windows Azure Hdinsightiga .NET SDK abil."
   services="hdinsight"
   documentationCenter=""
   tags="azure-portal"
   authors="mumian"
...
# <a name="create-windows-based-hadoop-clusters-in-hdinsight-using-net-sdk"></a>Kasutades .NET SDK Hdinsightiga Windowsi-põhiste Hadoopi kogumite loomine

[AZURE.INCLUDE [selector](../../includes/hdinsight-selector-create-clusters.md)]


Saate teada, kuidas luua Hdinsightiga kogumite, kasutades .NET SDK. Muud kobar loomise tööriistade ja funktsioonide klõpsake selle lehe ülaosas valige menüü või näha [kobar loomise võimalused](hdinsight-provision-clusters.md#cluster-creation-methods).
...
Hdinsightiga .NET SDK pakub .net-i kliendi teegid, mis oleks lihtsam töötada Hdinsightiga .NET Frameworki rakenduse. Järgige alltoodud Visual Studio konsooli rakendus ja kleepige kood luua klaster.

Rakenduse jaoks on vaja on Azure ressursirühm ja salvestusruumi vaikekonto.  [Lisa A](#appx-a-create-dependent-components) pakub PowerShelli skripti loomiseks sõltuvad komponendid.

**Visual Studio konsooli rakendus loomiseks**

1. Looge uus konsool rakendus C# Visual Studios.
2. Järgmine käsk Nugeti Nugeti pakett halduskonsoolis.
...
7. Vajutage klahvi **F5** käivitage rakendus. Konsooli aknas tuleks avada ja kuvada rakenduse olekut. Teil palutakse sisestada mandaat Azure'i konto. Selleks saate kuluda mitu minutit mõne Hdinsightiga kobar loomiseks.
...
##<a name="appx-a-create-dependent-components"></a>Appx-A loomine sõltuvad komponendid

Järgmised Azure PowerShelli skripti võib olla vajalik .net-i rakenduse selles õpetuses sõltuvad komponendid loomiseks kasutada.
