<properties
   pageTitle="Loogika rakendustes Yammer Connectori abil | Microsoft Azure'i rakendust Service"
   description="Kuidas luua ja Yammer Connectori või API rakenduse konfigureerimine ja kasutamine loogika rakenduse teenuses Azure rakendus"
   services="logic-apps"
...
# <a name="weve-improved-the-yammer-connector"></a>Meil on täiustatud Yammeri konnektor 
...
- [Lugege lisateavet see uue konnektor](../connectors/connectors-create-api-yammer.md)
