<properties 
    pageTitle="Vaikne kasutamisega loogika rakendustes | Microsoft Azure'i rakendust Service"
    description="Kuidas luua ja vaikne konnektor või API rakenduse konfigureerimine ja kasutamine loogika rakenduse teenuses Azure rakenduse"
    authors="msftman" 
    manager="erikre" 
    editor="" 
    services="logic-apps" 
...
# <a name="weve-improved-the-slack-connector"></a>Meil on täiustatud vaikne konnektor 
...
- [Lugege lisateavet see uue konnektor](../connectors/connectors-create-api-slack.md)
