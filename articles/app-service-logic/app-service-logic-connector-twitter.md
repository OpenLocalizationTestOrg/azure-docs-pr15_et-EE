<properties
   pageTitle="Loogika rakendustes kasutamisega Twitteri | Microsoft Azure'i rakendust Service"
   description="Kuidas luua ja konnektor Twitteri või API rakenduse konfigureerimiseks ja kasutamine loogika rakenduse teenuses Azure rakendus"
   services="logic-apps"
...
# <a name="weve-improved-the-twitter-connector"></a>Meil on täiustatud Twitteri konnektor 
...
- [Lugege lisateavet see uue konnektor](../connectors/connectors-create-api-twitter.md)
