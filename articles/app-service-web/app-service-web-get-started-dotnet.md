<properties 
    pageTitle="Võtta kasutusele Azure'i esimese .net-i veebirakenduse viis minutit | Microsoft Azure'i" 
...
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>Võtta kasutusele Azure'i esimese .net-i veebirakenduse viis minutit

Selle õpetuse abil saate juurutada [Azure'i rakendust Service](../app-service/app-service-value-prop-what-is.md)lihtne .NET web app.
...
## <a name="deploy-an-net-web-app"></a>.NET web app juurutamine
...
1. Töötamine kausta (`CD`) ja klooni valimi rakendus.
...
4. Luua rakenduse rakendust Service ressursi Azure kordumatu rakenduse nimi ja juurutamise kasutaja konfigureeritud varasemas versioonis. Kui teilt küsitakse, määrake soovitud piirkond arv.
    ...
    ![Azure'i Azure ressursi esimese veebirakenduse jaoks loomine](./media/app-service-web-get-started-languages/dotnet-site-create.png)
...
4. Nagu vajutada mis tahes koodi Git juurutada Azure rakenduse oma proovi kood. Vastava viiba kuvamisel kasutada varem konfigureeritud parool.
    ...
    ![Tõuketeatised koodi esimese veebirakendusse Azure](./media/app-service-web-get-started-languages/dotnet-git-push.png)

    `git push`mitte ainult paneb koodi Azure, aga ka taastab nõutav paketid ja koostab kahendfaile ASP.net-i. 
...
Siit saate teada, kuidas luua, arendada ja juurutada Azure otse veebisaidil [Deploy ASP.net-i web app Azure'i rakendust Service, kasutades Visual Studio](web-sites-dotnet-get-started.md)Visual Studio .net-i veebirakenduste.
