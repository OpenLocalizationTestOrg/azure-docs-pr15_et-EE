<properties 
   pageTitle="Kuidas määrata staatilise privaatne IP-aadress Azure'i ressursihaldur PowerShelli abil | Microsoft Azure'i"
   description="Staatilise privaatne IP-aadressid ja kuidas neid hallata Azure ressursihaldur PowerShelli abil mõistmine"
...
# <a name="how-to-set-a-static-private-ip-address-in-resource-manager-by-using-powershell"></a>Kuidas määrata staatilise privaatne IP-aadress on ressursihaldur PowerShelli abil

[AZURE.INCLUDE [virtual-networks-static-private-ip-selectors-arm-include](../../includes/virtual-networks-static-private-ip-selectors-arm-include.md)]

[AZURE.INCLUDE [virtual-networks-static-private-ip-intro-include](../../includes/virtual-networks-static-private-ip-intro-include.md)]

[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)]Selles artiklis antakse ülevaade ressursihaldur juurutamise mudel. Samuti saate [staatilise privaatne IP-aadress klassikaline juurutamise mudeli haldamine](virtual-networks-static-private-ip-classic-ps.md).

[AZURE.INCLUDE [virtual-networks-static-ip-scenario-include](../../includes/virtual-networks-static-ip-scenario-include.md)]

PowerShelli käskude allpool oodata on lihtne keskkond, mis on juba loodud valimi põhjal ülaltoodud stsenaariumi. Kui soovite käivitada käske, nagu need on kuvatud selles dokumendis, esmalt koostada testi keskkond, mis on kirjeldatud [on vnet loomine](virtual-networks-create-vnet-arm-ps.md).
...
1. Määrake muutujate salvestusruumi konto, asukoht, ressursirühm ja mandaadi kasutada. Peate sisestama kasutajanime ja parooli VM. Jaotis konto ja ressursside salvestusruumi peab juba olemas.
...
3. Saate tuua virtuaalse võrgu- ja soovite luua VM alamvõrgu.

        $vnet = Get-AzureRmVirtualNetwork -ResourceGroupName TestRG -Name TestVNet  
        $subnet = $vnet.Subnets[0].Id

4. Vajadusel looge VM Interneti kaudu juurdepääsu avaliku IP-aadress.

        $pip = New-AzureRmPublicIpAddress -Name TestPIP -ResourceGroupName $rgName -Location $locName -AllocationMethod Dynamic

5. Looge NIC, mis on staatiline privaatne IP-aadressi soovite määrata VM abil. Veenduge, et IP alamvõrgu vahemiku VM, et lisate on. See on peamine samm seda artiklit, kus saate määrata staatiline IP era.
...
6. Looge abil loodud kohal NIC VM.
...
Staatilise privaatne IP-aadressi teavet VM loodud ülaltoodud skripti kuvamiseks käivitage järgmine käsk PowerShelli ja jälgida väärtused *PrivateIpAddress* ja *PrivateIpAllocationMethod*:
...
Eemaldamiseks staatilise privaatne IP-aadress lisatakse VM skripti ülal, käivitage PowerShelli järgmised käsud:
