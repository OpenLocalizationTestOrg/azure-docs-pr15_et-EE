<properties
   pageTitle="SQL-i andmebaas süsteemi vaated | Microsoft Azure'i"
   description="Linkide süsteemi vaated sisu SQL-i andmebaas."
...
# <a name="system-views"></a>Süsteemi vaated

## <a name="sql-data-warehouse-catalog-views"></a>SQL-i andmebaas kataloogi vaadete
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>SQL-i andmebaas dünaamiline haldusvaated)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>SQL serveri DMVs kehtivad SQL-andmebaas

Järgmised DMVs rakenduvad SQL-i andmebaas, kuid **juhtslaidi** andmebaasiga ühenduse loomisel tuleb täita.

- [sys.database_service_objectives](https://msdn.microsoft.com/library/mt712619.aspx)
- [sys.dm_operation_status](https://msdn.microsoft.com/library/dn270022.aspx)
- [sys.fn_helpcollations()](https://msdn.microsoft.com/library/ms187963.aspx)

## <a name="sql-server-catalog-views"></a>SQL serveri kataloogi vaadete
...
## <a name="sql-server-dmvs-available-in-sql-data-warehouse"></a>SQL serveri DMVs saadaval rakenduses SQL-andmebaas

SQL-i andmebaas seab paljude SQL serveri dünaamilise halduse vaadete (DMVs). Need vaated, kui SQL-i andmebaas, päringuid on aruandlus SQL-i andmebaaside selle jaotuse olek.

Kuna SQL-i andmebaas on ehitatud Microsofti MPP tehnoloogia, nii SQL-i andmebaas ja Analytics platvormi süsteemi paralleelselt andmete ladu (PDW) kasutada sama süsteemi vaated.

Sellepärast, et need DMV on teatud veerg nimega pdw_node_id. See on selle tunnuse Arvuta sõlme. PDW on Arvuta sõlm on tugevam kontseptsiooni arhitektuur. Klõpsake SQL-i andmebaas, arhitektuur sõltub rohkem selle jaotuse.

>[AZURE.NOTE] Nende vaate kasutamiseks sisestage 'pdw_nodes_' nimi, nagu on näidatud järgmises tabelis.


| DMV nime SQL-andmebaas | Link teemale SQL Server Transact-SQL-MSDN-is |
| :----------------------------- | :-------------------------------------------- |
...
| sys.dm_pdw_nodes_os_dispatchers | Transact-SQL-i dokumentatsiooni pole saadaval. |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats | Transact-SQL-i dokumentatsiooni pole saadaval. |
...
| sys.dm_pdw_nodes_os_spinlock_stats | Transact-SQL-i dokumentatsiooni pole saadaval. |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-data-warehouse"></a>SQL Server 2016 PolyBase DMVs saadaval rakenduses SQL-andmebaas
...
## <a name="sql-server-informationschema-views"></a>SQL serveri INFORMATION_SCHEMA vaated

- [CHECK_CONSTRAINTS](http://msdn.microsoft.com/library/ms189772.aspx)
- [VEERUD](http://msdn.microsoft.com/library/ms188348.aspx)
- [PARAMEETRID](http://msdn.microsoft.com/library/ms173796.aspx)
- [MOODULID](https://msdn.microsoft.com/library/ms188757.aspx)
- [SCHEMATA](https://msdn.microsoft.com/library/ms182642.aspx)
- [TABELID](http://msdn.microsoft.com/library/ms186224.aspx)
...
- [VAATED](http://msdn.microsoft.com/library/ms181381.aspx)
